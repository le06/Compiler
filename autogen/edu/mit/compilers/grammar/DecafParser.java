...
public DecafParser(ParserSharedInputState state) {
  ...
  astFactory = new ASTFactory(getTokenTypeToASTClassMap());
	...
	public final void if_statement() throws RecognitionException, TokenStreamException {
		...
		try { // debugging
			...
			try {      // for error handling
				...
				if_statement_AST = (AST)astFactory.make( (new ASTArray(4)).add(tmp38_AST).add(cond_AST).add(if_block_AST).add(else_block_AST));
	...
	public final void expr_t() throws RecognitionException, TokenStreamException {
		...
		try { // debugging
			...
			try {      // for error handling
				...
				else if ((_tokenSet_10.member(LA(1))) && (_tokenSet_11.member(LA(2))) && (_tokenSet_16.member(LA(3)))) {
					expr_tm();
					astFactory.addASTChild(currentAST, returnAST);
					expr_t_AST = (AST)currentAST.root;
				}
	...
	private static final long[] mk_tokenSet_7() {
		long[] data = { 13194141630464L, 64L, 0L, 0L};
		return data;
	}
	...
	private static final long[] mk_tokenSet_10() {
		long[] data = { 144537401354617088L, 128L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_10 = new BitSet(mk_tokenSet_10());
	private static final long[] mk_tokenSet_11() {
		long[] data = { 144647351466721536L, 128L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_11 = new BitSet(mk_tokenSet_11());
	private static final long[] mk_tokenSet_12() {
		long[] data = { 432890921757636034L, 192L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_12 = new BitSet(mk_tokenSet_12());
	private static final long[] mk_tokenSet_13() {
		long[] data = { 432890921759800770L, 192L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_13 = new BitSet(mk_tokenSet_13());
	private static final long[] mk_tokenSet_14() {
		long[] data = { 123144786411520L, 64L, 0L, 0L};
		return data;
	}
	...
	private static final long[] mk_tokenSet_16() {
		long[] data = { 432890921759733186L, 192L, 0L, 0L};
		return data;
	}
